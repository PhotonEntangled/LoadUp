// LoadUp Beta Server (CommonJS version)
// A simplified server for beta testing
...
// Configuration
const PORT = process.env.PORT || 3002; // Use beta port by default
...
process.on('uncaughtException', (err) => {
  ...
  console.error('Server will continue running, but please fix this error!');
});
...
process.on('SIGINT', () => {
  console.log('Shutting down beta server...');
  server.close(() => {
