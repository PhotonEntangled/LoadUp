...
import { FileText, Home, Map, Settings, Truck, Sun, Moon, User, Route } from "lucide-react"
    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <header className="flex h-14 items-center border-b border-border bg-background px-4 md:px-6">
          ...
          {/* Page Title - Only shown on mobile when sidebar is hidden */}
          <div className="ml-auto md:ml-0 text-sm font-medium text-muted-foreground">
