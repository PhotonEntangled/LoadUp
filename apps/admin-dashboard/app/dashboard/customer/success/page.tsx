              ...
              <div className="flex">
                ...
                <div className="ml-3 flex-1">
                  <p className="text-sm text-orange-700">
                    The customer portal is currently under development. Check back soon for updates!
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex">
                <div className="flex-shrink-0">
                  ...
                  >
                    ...
                    ></path>
                    <path
                      d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1v-5h2.038A2.968 2.968 0 0115 12.5a2.976 2.976 0 01-1.293 2.5H15a1 1 0 001-1V6a1 1 0 00-1-1H3z"
                    ></path>
                  </svg>
                </div>
                <div className="ml-3 flex-1">
