...
export function SheetSelect({
  ...
  // Filter out any sheet name that might clash with the static 'all' option
  const filteredSheets = sheets.filter(sheet => sheet.toLowerCase() !== 'all');
  
  const options = [
    { value: "all", label: "All Sheets" },
    ...filteredSheets.map((sheet) => ({ value: sheet, label: sheet })),
  ];
