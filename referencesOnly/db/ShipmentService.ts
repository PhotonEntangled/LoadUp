...
import {
  ...
  type SelectShipmentLocation,
  type InsertShipmentContact,
  type SelectShipmentContact,
  type InsertShipmentStatus,
  type SelectShipmentStatus,
  type InsertShipmentEvent,
  type SelectShipmentEvent,
} from '@/lib/database/schema/shipments';
